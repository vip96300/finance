...
public class SmsUtils {
	...
	//api key
	private static final String API_KEY="6c738ecffb68f26f4baabb488eec8119";
	/**
	 * 发送短信
	 * @param mobile 手机
	 * @param code 验证码
	...
	public static boolean send(String mobile,String code){
		try {
			...
			System.out.println(SmsUtils.tplSendSms(API_KEY, tpl_id, tpl_value,mobile));	
			return true;
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @param operate
	 */
	public static void sendError(String mobile,String operate){
		try {
			long tpl_id = 2158498;
			String tpl_value = URLEncoder.encode("#operate#", ENCODING) + "="+ URLEncoder.encode(operate, ENCODING);
			System.out.println(SmsUtils.tplSendSms(API_KEY, tpl_id, tpl_value,mobile));	
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/*public static void main(String[] args) throws IOException,URISyntaxException {
		SmsUtils.send("15023343740","123456");
		//**************** 查账户信息调用示例 *****************//*
		//System.out.println(SmsUtils.getUserInfo(API_KEY));
		...
		String tpl_value = URLEncoder.encode("#code#", ENCODING) + "="
				...
				+ URLEncoder.encode("老板娱乐", ENCODING);
		// 模板发送的调用示例
		...
		//**************** 使用接口发语音验证码 *****************//*
		String code = "1234";
		// System.out.println(JavaSmsApi.sendVoice(API_KEY, mobile ,code));

		//**************** 使用接口绑定主被叫号码 *****************//*
		String from = "+86130xxxxxxxx";
		String to = "+86131xxxxxxxx";
		Integer duration = 30 * 60; // 绑定30分钟
		// System.out.println(JavaSmsApi.bindCall(API_KEY, from ,to , duration));

		//**************** 使用接口解绑主被叫号码 *****************//*
		// System.out.println(JavaSmsApi.unbindCall(API_KEY, from, to));
	}*/
