...
public class YeepayService {
	...
	static String customerNumber = Config.getInstance().getValue("customerNumber");
	static String baseUri = Config.getInstance().getValue("baseUri");
	...
	public static Map<String, String> yeepayYOP(Map<String, String> map,String Uri) {
		...
		YopRequest yoprequest = new YopRequest("OPR:" + customerNumber, "",
				baseUri);
	...
	public static String yosFile(Map<String, String> params, String path) {
		...
		try {
			...
			inputStream = apidApi.remitDayBillDownload(customerNumber, date,
					dataType);
